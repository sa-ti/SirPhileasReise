    ...
    if ((count < 2) &&  ($(this).children("img").hasClass("aufgedeckt")) === false) {
        ...
        if (count === 1 ) {
            ...
            if (guess1 === guess2) {
                ...
                turns--;
                if(turns == 25){
                    document.getElementById("progress").src ="../assets/images/progress3.png";
                    console.log("hintergrund changed");

                }
                if(turns == 15){
                    document.getElementById("progress").src ="../assets/images/progress2.png";
                }
                if(turns == 5){
                    document.getElementById("progress").src ="../assets/images/progress4.png";
                }
                if(turns == 0){
                    var r = confirm("Du hast keine Züge mehr übrig!\nDurch drücken auf OK kannst du es erneut" +
                        " versuchen, durch abbrechen gelangst du zu deiner Karte.")
                    if(r){
                        location.reload()
                    }
                    else{
...
function getQuestions(guess1){
    ...
    // Fragen über routes aus QuestionsAplication beziehen
    $.ajax({
        url:"loadQuestionsL2",
        method: "GET",
        dataType: "json",
